        ...
        <div className="container mx-auto px-6 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="services" className="hover:text-white transition-colors">Shingle Repair</a></li>
                <li><a href="services" className="hover:text-white transition-colors">Flat Roof Solutions</a></li>
                <li><a href="services" className="hover:text-white transition-colors">Tile Repair</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-center">
                  ...
                  <span>(855) 808-8887</span>
                </li>
                <li className="flex items-center">
                  <svg className="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                  </svg>
                  <span>roofers@sw.solar</span>
                </li>
                <li className="flex items-center">
                  <svg className="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
